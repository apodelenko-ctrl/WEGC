...
${env.PUBLIC_INTAKE_SUBMISSIONS_PAUSED==='true'?'<p role="status">Приём новых запросов временно приостановлен. Сохранённую квитанцию можно проверить ниже.</p>':''}
