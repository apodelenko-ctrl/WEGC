...
const server=http.createServer(async(req,res)=>{try{
 ...
 const asset=assets[url.pathname];if(!asset){res.writeHead(404);res.end();return;}res.writeHead(200,{'Content-Type':asset[1]});res.end(readFileSync(new URL(asset[0],root)));
