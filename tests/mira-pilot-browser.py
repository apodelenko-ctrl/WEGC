...
async def main():
 ...
 try:
  ...
  async with async_playwright() as p:
   browser=await p.chromium.launch(executable_path=os.environ.get('CHROMIUM_PATH','/Applications/Google Chrome.app/Contents/MacOS/Google Chrome'),headless=True)
   ...
   errors=[]
   for page in [operator,applicant,other]:page.on('pageerror',lambda e:errors.append(str(e)))
